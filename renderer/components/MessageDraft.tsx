                ...
                >
                    ...
                    >
                        ...
                        >
                            <Input
                                onChange={(e) =>
                                    setDraftMessage({ ...draftMessage, to: e.target.value })
                                }
                                variant="unstyled"
                                placeholder="To"
                                color="gray.200"
                            ...
                            <Input
                                onChange={(e) =>
                                    setDraftMessage({ ...draftMessage, subject: e.target.value })
                                }
                                variant="unstyled"
                                placeholder="Subject"
                                color="gray.200"
                                value={draftMessage.subject}
                            />
                            <Box h={2} borderTop="1px solid" borderColor="gray.600" marginTop={2} />
                            <ContentEditable
                                innerRef={editRef}
                                html={draftMessage.body}
                                onChange={(e) =>
                                    setDraftMessage({ ...draftMessage, body: e.target.value })
                                }
                                style={{
                                    color: "gray.200",
                                    outline: "none",
                    ...
                    >
                        <Button
                            onClick={persistNewMessage}
                            isDisabled={draftMessage.to === "" || draftMessage.subject === ""}
                            variant="ghost"
                            bg="blue.500"
